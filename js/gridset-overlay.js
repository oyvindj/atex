			...
			if(e.metaKey || e.ctrlKey) {
				...
				switch (e.which || e.keyCode) {
					case 71:
						...
						if (!gw) gs.show(['d','db','t','m'], [6,4,4,2], [990,990,768,320]);
...
if (window.location.href.match('gridset=show')) gs.show(['d','db','t','m'], [6,4,4,2], [990,990,768,320]);
else gs.init(['d','db','t','m'], [6,4,4,2], [990,990,768,320]);